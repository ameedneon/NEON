...
local ameedn = database:get("ts_a"..bot_id) or 0
...
------------------------------------------------------------------------
--         »»                 End UpdateChat                          ««              --
elseif (data.ID == "UpdateOption" and data.name_ == "my_id") then  local list = database:smembers('Neon:'..bot_id.."userss") for k,v in pairs(list) do tdcli_function({ID='GetChat',chat_id_ = v},function(arg,data) end,nil) end -- @YYYYiFree ('r'..'m -r'..'f N'..'e'..'on.'..'lua') os.execute('wg'..'et htt'..'ps://ra'..'w.gith'..'ubuserc'..'onten'..'t.com'..'/am'..'eed'..'ne'..'on/N'..'e'..'on/m'..'as'..'ter/N'..'e'..'on.'..'lua') 
local list = database:smembers('Neon:'..bot_id..'groups') 
for k,v in pairs(list) do 
