...
ameed = ameed .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق تشاكي لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
os.execute('cd libs;wget https://raw.githubusercontent.com/Neonabas/Neon/master/libs/utils.lua')
os.execute('wget https://raw.githubusercontent.com/Neonabas/Neon/master/Neon.lua')
dofile('Neon.lua')  
return false
end
