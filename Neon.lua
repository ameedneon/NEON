...
{
{text = ''..(channel_ts or "Neon TEAM")..'', url=''..(channel_user_ts or 't.me/YYYYi')..''},
},
}
...
info = '👤⁞ بواسطه ← ['..result.first_name_..'](t.me/'..(result.username_ or 'YYYYi')..')\n'..text
...
info = '👤⁞ العضو ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'YYYYi')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '👤⁞ العضو ~⪼ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'YYYYi')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
send(msg.chat_id_,0, 1, "⚠⁞ العضو : {["..data.first_name_.."](T.ME/YYYYi)}\n📛⁞ ["..beko.."] \n" , 1, 'md') 
end
end
...
send(msg.chat_id_,0, 1, "⚠⁞ عذرا يا » {["..data.first_name_.."](T.ME/YYYYi)}\n📛⁞  الملصق الذي ارسلته تم منعه من المجموعه \n" , 1, 'md') 
end
end
getUser(msg.sender_user_id_,get_info)
delete_msg(msg.chat_id_,{[0] = msg.id_})       
...
local hash =  'Neon:'..bot_id..'gbanned:'
texts = '👤⁞ العضو ~⪼ ['..result.title_..'](t.me/'..(apbll[2] or 'YYYYi')..')\n🚫⁞ تم حظره من المجموعات البوت'
...
local hash =  'Neon:'..bot_id..'gbanned:'
if result.id_ then
texts = '👤⁞ العضو ~⪼ ['..result.title_..'](t.me/'..(apid[2] or 'YYYYi')..')\n��⁞ تم الغاء حظره من المجموعات البوت'
...
texts = '👤⁞ العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'YYYYi')..')\n\n🔖⁞ تم رفعة مطور في البوت'
else
texts = '✖⁞ خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
texts = '👤⁞ العضو ~⪼ ['..result.title_..'](t.me/'..(apow[2] or 'YYYYi')..')\n🔖⁞ تم رفعة منشئ  في البوت'
else
texts = '✖⁞ خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
info = '👤⁞ العضو ~⪼ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'YYYYi')..')\n☑⁞ تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
texts = '👤⁞ العضو ~⪼ ['..result.title_..'](t.me/'..(apba[2] or 'YYYYi')..')\n☑⁞ تم حظره من المجموعه'
...
texts = '👤⁞ العضو ~⪼ ['..result.title_..'](t.me/'..(apsi[2] or 'YYYYi')..')\n🚫⁞ تم كتمه من البوت'
end
else
texts = '✖⁞ خطاء'
end
...
texts = '👤⁞ العضو ~⪼ ['..result.title_..'](t.me/'..(apki[2] or 'YYYYi')..')\n🚫⁞ تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖⁞ خطاء'
...
texts = '👤⁞ العضو ~⪼ ['..result.title_..'](t.me/'..(res[2] or 'YYYYi')..')\n☑️⁞ تم تقييده'
end
else
texts = '✖️⁞ خطاء'
end
...
send(msg.chat_id_,0, 1, "[⚠⁞ #تحذير] \n🔖⁞ قام شخصآ ما في المجموعه بالتعديل على الميديا يرجى الانتباه \n📫⁞ الشخص الي قام بالتعديل \n ["..data.first_name_.."](T.ME/YYYYi)" , 1, 'md') 
end
end
