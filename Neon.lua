...
ameed = ameed .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق نيون لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
local beko = database:get('Neon:'..bot_id.."filtr1:add:reply:rd"..text..msg.chat_id_)   
if beko then    
...
local res = https.request('https://api.telegram.org/bot1051729836:AAF1PaPuAqUGP9szwhEEO2Y4qFagtCfL2mU/getChatMember?chat_id=@BB8SS&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot811517309:AAEBec_wk81nh6and9t2vp8znFFTbLclp94/getChatMember?chat_id=@BB8SS&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot811517309:AAEBec_wk81nh6and9t2vp8znFFTbLclp94/getChatMember?chat_id=@BB8SS&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot666998640:AAEOwMMQU8pzy60wLF23EiXjbfVsI6jrQAk/getChatMember?chat_id=@BB8SS&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot827950325:AAGjaAxIwupH9vWLvB3JIRZRGFHhSVZsM9Y/getChatMember?chat_id=@BB8SS&user_id='..msg.sender_user_id_)--ttps.request('https://teamstorm.tk/joinch/?id='..msg.sender_user_id_..'')
...
send(msg.chat_id_, msg.id_, 1,'\n♥️ أهـلأ بك عزيزي .\n🚫 لايمڪنك استخدام البوت .\n⚠️ يجب عليك الاشتراك في القناة .\n• @BB8SS ⚜️\n', 1, 'html')   
return false end
...
send(msg.chat_id_, msg.id_, 1, '⚠⁞ عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗⁞ لانه لا يدعم سورس نيون \n 🦁⁞ [ملفات يدعمها سورس نيون](t.me/BB8SS)', 1, 'md')
end
else
send(msg.chat_id_, msg.id_, 1, '⚠⁞ عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗⁞ لانه لا يدعم سورس نيون \n 🦁⁞ [ملفات يدعمها سورس نيون](t.me/BB8SS)', 1, 'md')
end
...
for k,v in pairs(list) do  
local beko = database:get('Neon:'..bot_id.."filtr1:add:reply:rd"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..beko..'}\n'    
end  
if #list == 0 then  
...
------------------------------------------------------------------------
if (text and text == (redis:get('Neon:'..bot_id..'name_bot') or 'نيون'))then
name_bot = (redis:get('Neon:'..bot_id..'name_bot') or 'نيون')
local namebot = {
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"📷⁞ صورتك :   "..ameed_text[ameed3].."\n🆔⁞ ايديك :  "..msg.sender_user_id_.."\n📤⁞ معرفك :  "..ameed_info.."\n⏱⁞ موقعك :  "..t.."\n📨⁞ رسائلك :  ("..user_msgs..")\n📥⁞ السحكات : ("..edit..")\n🌟⁞ تفاعلك :  ("..iameed_text..")\n🏆⁞ نقاطك :  ("..nko..")\n————————————————",msg.id_,msg.id_.."")
else 
...
beko = '*💎⁞  عدد نقاطك الحاليه  ('..(database:get('Neon:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_))..')*'
beko1 = '*💎⁞  مجموع نقاطك ('..(database:get('Neon:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))..')*'
...
beko = (database:get('Neon:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) * tonumber(database:get('Neon:'..bot_id..'gamepoint' .. msg.chat_id_)or 50))
database:incrby('Neon:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_,beko)  
database:del('Neon:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_)
beko = tonumber((database:get('Neon:'..bot_id..'gamepoint' .. msg.chat_id_) or 50))
...
local text =  [[
👋⁞ اهلا بك في سورس نيون .

🌐⁞ [قناة السورس ](t.me/BB8SS)

🔎⁞ [بوت يوتيوب ](t.me/xvxbot)
🔎⁞ [بوت سمسمي ](t.me/w8wbot)
🔎⁞ [بوت زخرفة ](t.me/gg8bot)
🔎⁞ [بوت الابراج ](t.me/hjjbot)
...
local Name_Bot = (redis:get('Neon:'..bot_id..'name_bot') or 'نيون')
...
------------------------------------------------------------------------
local beko = database:get('Neon:'..bot_id.."add:reply:rd"..text..msg.chat_id_)   
